...
class ConnectionManager {
    ...
    _onClientListens(socket, eventNameStr, queueKeyStr) {
        ...
        try {
            ...
            this._sendAvailableMessages(eventName, queueKey);
    ...
    _sendAvailableMessages(eventKey, clientKey) {
        ...
        try {
            ...
            for (let i = 0; i < res.length; i++) {
                ...
                this.socketIoServer.sockets.in(clientKey).emit('message', clientKey, [messageData]);
            }
        }
        catch (err) {
