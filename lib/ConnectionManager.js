...
class ConnectionManager {
    ...
    _onClientListens(socket, eventNameStr, queueKeyStr) {
        ...
        try {
            ...
            this._sendAvailableMessages(queueKey, eventName);
    ...
    _sendAvailableMessages(clientKey, eventKey) {
    ...
    _parseKey(token, socket) {
        try {
            ...
            KalturaLogger.error(KalturaPushServerErrors.TOKEN_DECRYPTION_ERROR + " error message: " + err.message + " stack: " + err.stack);
